...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-ast-dark">
      ...
      {/* Scroll Indicator (Naturally positioned inside hero section) */}
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 animate-bounce text-ast-light/60 flex flex-col items-center gap-1 pointer-events-none">
